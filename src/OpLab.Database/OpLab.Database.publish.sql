...
GO
:setvar DatabaseName "OpLab"
:setvar DefaultFilePrefix "OpLab"
...
GO
PRINT N'Creating [dbo].[PointsOfInterest]...';
...
GO
PRINT N'Creating [dbo].[FK_PointsOfInterest_Cities]...';


GO
ALTER TABLE [dbo].[PointsOfInterest]
    ADD CONSTRAINT [FK_PointsOfInterest_Cities] FOREIGN KEY ([CityId]) REFERENCES [dbo].[Cities] ([Id]);
